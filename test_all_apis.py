    ...
    try:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                print(f"{total_tests}. ❌ GET /api/status - فشل (Status: {response.status_code})")
                failed_tests += 1
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                print(f"{total_tests}. ❌ GET /api/health - فشل (Status: {response.status_code})")
                failed_tests += 1
        except Exception as e:
        ...
        try:
            ...
            if response.status_code in [400, 401]:
                ...
                print(f"{total_tests}. ❌ POST /api/auth/login - فشل (Status: {response.status_code})")
                failed_tests += 1
        except Exception as e:
        ...
        try:
            ...
            if response.status_code in [401, 403]:
                ...
                print(f"{total_tests}. ❌ GET /api/products - فشل (Status: {response.status_code})")
                failed_tests += 1
        except Exception as e:
        ...
        try:
            ...
            if response.status_code in [401, 403]:
                ...
                print(f"{total_tests}. ❌ GET /api/customers - فشل (Status: {response.status_code})")
                failed_tests += 1
        except Exception as e:
        ...
        try:
            ...
            if response.status_code in [401, 403]:
                ...
                print(f"{total_tests}. ❌ GET /api/suppliers - فشل (Status: {response.status_code})")
                failed_tests += 1
        except Exception as e:
        ...
        try:
            ...
            if response.status_code in [401, 403]:
                ...
                print(f"{total_tests}. ❌ GET /api/invoices - فشل (Status: {response.status_code})")
                failed_tests += 1
        except Exception as e:
