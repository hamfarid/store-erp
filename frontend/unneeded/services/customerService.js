...
export const customerService = {
  ...
  async getVipCustomers(params = {}) {
    try {
      const response = await apiClient.get('/customers/vip', params);
      return response.customers || response.data || [];
    } catch (error) {
  ...
  async getTopCustomers(params = {}) {
    try {
      const response = await apiClient.get('/customers/reports/top-customers', params);
      return response.customers || response.data || [];
    } catch (error) {
  ...
  async getAgingReport(params = {}) {
    try {
      const response = await apiClient.get('/customers/reports/aging', params);
  ...
  async getSalesReport(params = {}) {
    try {
      const response = await apiClient.get('/customers/reports/sales', params);
  ...
  async bulkUpdate(updates) {
    try {
      const response = await apiClient.post('/customers/bulk-update', { updates });
      return response;
    } catch (error) {
  ...
  async bulkAssignSalesEngineer(customerIds, salesEngineerId) {
    try {
      const response = await apiClient.post('/customers/bulk-assign-sales-engineer', {
  ...
  async checkPhoneExists(phone, excludeId = null) {
    try {
      ...
      const response = await apiClient.get('/customers/check-phone', params);
  ...
  async checkEmailExists(email, excludeId = null) {
    try {
      ...
      const response = await apiClient.get('/customers/check-email', params);
      return response.exists || false;
    } catch (error) {
      return false;
    }
  ...
  async validateCustomer(customerData) {
    try {
      const response = await apiClient.post('/customers/validate', customerData);
      return response;
    } catch (error) {
