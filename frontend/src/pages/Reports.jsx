...
const Reports = () => {
  ...
  const loadInitialData = async () => {
    try {
      ...
      const [
        ...
        warehousesData,
        customersData,
        // suppliersData, // Currently unused
        // productsData, // Currently unused
        categoriesData,
        salesPersonsData
      ...
      // if (suppliersData.status === 'fulfilled') setSuppliers(suppliersData.value); // setSuppliers not defined
      // if (productsData.status === 'fulfilled') setProducts(productsData.value); // setProducts not defined
  ...
  const handleAddToFavorites = async (_reportId) => {
    try {
  ...
  const handleRemoveFromFavorites = async (_reportId) => {
    try {
  ...
  const handleDownloadReport = async (_reportId) => {
    try {
