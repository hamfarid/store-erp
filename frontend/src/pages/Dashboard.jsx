...
const Dashboard = () => {
  ...
  // Sample data
  const stats = [
    { title: 'إجمالي المبيعات', value: '125,430 ج.م', change: 12.5, changeType: 'up', icon: DollarSign, color: 'teal' },
  ...
  const recentActivities = [
    { type: 'sale', title: 'فاتورة مبيعات #1234', description: 'أحمد محمد - 5 منتجات', time: 'منذ 5 دقائق', amount: '+2,450 ج.م' },
    { type: 'purchase', title: 'طلب شراء #567', description: 'مورد الإلكترونيات', time: 'منذ 15 دقيقة', amount: '-12,000 ج.م' },
    { type: 'payment', title: 'دفعة من عميل', description: 'شركة الفيصل التجارية', time: 'منذ 30 دقيقة', amount: '+5,000 ج.م' },
    { type: 'return', title: 'إرجاع منتج', description: 'هاتف سامسونج - عيب مصنعي', time: 'منذ ساعة', amount: '-1,200 ج.م' },
    { type: 'sale', title: 'فاتورة مبيعات #1233', description: 'محمد علي - 3 منتجات', time: 'منذ ساعتين', amount: '+890 ج.م' },
  ];
  ...
  const topProducts = [
    { rank: 1, name: 'آيفون 15 برو ماكس', sales: 234, revenue: '468,000 ج.م', trend: 23 },
    { rank: 2, name: 'سماعات إيربودز برو', sales: 189, revenue: '94,500 ج.م', trend: 15 },
    { rank: 3, name: 'شاحن لاسلكي MagSafe', sales: 156, revenue: '31,200 ج.م', trend: -5 },
    { rank: 4, name: 'حافظة آيفون جلد', sales: 142, revenue: '28,400 ج.م', trend: 8 },
    { rank: 5, name: 'كابل USB-C', sales: 128, revenue: '6,400 ج.م', trend: 12 },
  ];
