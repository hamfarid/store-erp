  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 p-8" dir="rtl">
      ...
      <div className="stats-grid">
        <StatCard title="إجمالي المبيعات" value="1.2M ج.م" change={12.5} isPositive={true} icon={DollarSign} color="bg-teal-500" />
        <StatCard title="الطلبات" value="1,284" change={8.2} isPositive={true} icon={ShoppingCart} color="bg-blue-500" />
        <StatCard title="صافي الربح" value="245K ج.م" change={5.3} isPositive={true} icon={TrendingUp} color="bg-emerald-500" />
        <StatCard title="المصروفات" value="85K ج.م" change={3.1} isPositive={false} icon={TrendingDown} color="bg-rose-500" />
      </div>
