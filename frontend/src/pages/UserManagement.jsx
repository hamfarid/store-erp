...
const UserManagement = () => {
  ...
  // const { user: currentUser, hasPermission } = usePermissions(); // Currently unused
  ...
  const handleToggleUserStatus = async (_userId, _currentStatus) => {
    try {
      // await userService.toggleStatus(_userId, !_currentStatus);
      await loadData();
    } catch (error) {
