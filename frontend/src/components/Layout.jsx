...
const Layout = () => {
  ...
  const { isConnected, lastChecked: _lastChecked } = useConnectionStatus(30000) // Check every 30 seconds
  ...
  return (
    <div className={`app-container min-h-screen ${isDark ? 'dark bg-gray-900' : 'bg-muted/50'}`} dir="rtl">
      {/* Header */}
      <header className={`fixed-header shadow-sm border-b border-border ${isDark ? 'bg-gray-800 text-white' : 'bg-white'}`}>
