...
// import api from '../services/api'; // Currently unused
...
const UnifiedDashboard = () => {
  ...
  const StatCard = ({ title, value, icon: IconComponent, color, subtitle, trend }) => (
  ...
  const QuickActionCard = ({ title, description, icon: IconComponent, color, onClick, badge }) => (
    <div
