    ...
    <div className="p-6 bg-white rounded-lg shadow-lg">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="bg-blue-50 p-4 rounded-lg">
          ...
          <p className="text-3xl font-bold text-blue-600">{salesData.total_sales.toLocaleString()} ج.م</p>
        </div>
        ...
        <div className="bg-purple-50 p-4 rounded-lg">
          ...
          <p className="text-3xl font-bold text-purple-600">{salesData.average_order_value} ج.م</p>
        </div>
      </div>
    ...
    <div className="p-6 bg-white rounded-lg shadow-lg">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
        ...
        <div className="bg-green-50 p-4 rounded-lg">
          ...
          <p className="text-2xl font-bold text-green-600">{inventoryData.total_value.toLocaleString()} ج.م</p>
        </div>
