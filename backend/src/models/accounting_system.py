...
# mypy: ignore-errors
"""
accounting_system - نموذج أساسي

This module contains SQLAlchemy models for the accounting system.
Mock objects are provided when SQLAlchemy is not available.
