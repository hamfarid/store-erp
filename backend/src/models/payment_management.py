...
class PaymentOrder(db.Model):
    ...
    creator = relationship(
        ...
        backref="created_payment_orders",
    )
    approver = relationship(
        "src.models.user.User",
        foreign_keys=[approved_by],
        backref="approved_payment_orders",
    )
    payer = relationship(
        "src.models.user.User", foreign_keys=[paid_by], backref="paid_payment_orders"
    )
...
class DebtRecord(db.Model):
    ...
    creator = relationship("src.models.user.User", backref="created_debt_records")
...
class DebtPayment(db.Model):
    ...
    # العلاقات
    creator = relationship("src.models.user.User", backref="created_debt_payments")
...
class DebtFollowUp(db.Model):
    ...
    creator = relationship("src.models.user.User", backref="created_debt_follow_ups")
...
class PaymentProcessingLog(db.Model):
    ...
    creator = relationship("src.models.user.User", backref="created_payment_logs")
...
class PaymentAttachment(db.Model):
    ...
    uploader = relationship(
        "src.models.user.User", backref="uploaded_payment_attachments"
    )
