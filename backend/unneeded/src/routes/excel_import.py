# FILE: backend/src/routes/excel_import.py | PURPOSE: Routes with P0.2.4 error envelope | OWNER: Backend | RELATED: middleware/error_envelope_middleware.py | LAST-AUDITED: 2025-10-25
...
# Prefer canonical unified models and src.database; avoid legacy 'models.*' to prevent duplicate mappers
try:
