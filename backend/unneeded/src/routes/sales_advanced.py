...
class SalesInvoice(db.Model):
    ...
    if SQLALCHEMY_AVAILABLE:
        customer = relationship("src.models.customer.Customer", backref=backref("sales_invoices", lazy="dynamic"))  # type: ignore[name-defined]
        sales_engineer = relationship("src.models.sales_engineer.SalesEngineer", backref=backref("assigned_invoices", lazy="dynamic"))  # type: ignore[name-defined]
        items = relationship(
...
class CustomerPayment(db.Model):
    ...
    if SQLALCHEMY_AVAILABLE:
        ...
        customer = relationship("src.models.customer.Customer", backref=backref("customer_payments", lazy="dynamic"))  # type: ignore[name-defined]
