# FILE: backend/src/routes/mfa_routes.py | PURPOSE: P0.1.3 - MFA (Multi-Factor Authentication) endpoints | OWNER: Backend Security | RELATED: auth_routes.py, models/user.py | LAST-AUDITED: 2025-10-25
