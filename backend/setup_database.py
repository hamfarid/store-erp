...
def insert_sample_data(conn):
    ...
    warehouses_data = [
        ...
        ("مخزن الإسكندرية", "ALEX", "فرع الإسكندرية", "محمد أحمد", "01222222222"),
    ...
    for i in range(100):  # 100 حركة وارد
        ...
        """,
            (product_id, quantity, unit_price, total_value, f"PO-{1000+i}", created_at),
        )
    ...
    for i in range(80):  # 80 حركة صادر
        ...
        """,
            (product_id, quantity, unit_price, total_value, f"SO-{2000+i}", created_at),
        )
        ...
        for warehouse_id in warehouse_ids:
            ...
            if total_stock > 0:
                ...
                if warehouse_id == 1:  # المخزن الرئيسي
                    ...
                    quantity = int(total_stock * 0.4 / (len(warehouse_ids) - 1))
