...
def create_app(config=None):
    ...
    # Enable CORS - Allow specific origins for development
    # Frontend may run on different ports (5505, 5506, 5507, 5508, etc.)
    allowed_origins = [
        "http://localhost:5505",
        "http://localhost:5506",
        "http://localhost:5507",
    ...
    CORS(
        ...
        resources={
            r"/api/*": {
                ...
                "supports_credentials": True,  # Allow credentials with specific origins
            }
        },
    )
