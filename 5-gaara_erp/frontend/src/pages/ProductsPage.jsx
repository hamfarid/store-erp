  ...
  <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden hover:shadow-xl transition-all duration-300 group">
    ...
    <div className="p-4">
      ...
      <div className="flex items-center justify-between">
        <div>
          <p className="text-lg font-bold text-teal-600">{product.price.toLocaleString()} ر.س</p>
          <p className="text-xs text-gray-400">التكلفة: {product.cost.toLocaleString()} ر.س</p>
        </div>
...
const ProductRow = ({ product, onView, onEdit, onDelete }) => (
  <tr className="hover:bg-gray-50 transition-colors">
    ...
    <td className="px-6 py-4">
      <p className="font-semibold text-gray-900">{product.price.toLocaleString()} ر.س</p>
