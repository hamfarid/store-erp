...
import { ProtectedRoute, PermissionGuard, AdminOnly } from './auth/ProtectedRoute';
...
// Note: ProtectedRoute is now imported from './auth/ProtectedRoute' for comprehensive features:
// - Multiple permission checks (requiredPermission, requiredPermissions)
// - Role-based access control (requiredRole, requireAdmin)
// - Custom loading and unauthorized pages
      ...
      <AuthProvider>
        <Router>
          ...
          <Route path="/" element={
            ...
            {/* ═══════════════════════════════════════════════════════════════ */}
            {/* HR Module Routes - إدارة الموارد البشرية                        */}
            {/* ═══════════════════════════════════════════════════════════════ */}
