...
const SidebarEnhanced = () => {
  ...
  const menuSections = [
    ...
    },
    {
      ...
      items: [
        ...
        { path: '/lot-batch-management', icon: Database, label: 'إدارة الدفعات', badge: 'جديد' },
        { path: '/warehouse-transfer', icon: Truck, label: 'تحويلات المخازن', badge: 'جديد' },
        { path: '/inventory-alerts', icon: AlertCircle, label: 'تنبيهات المخزون', badge: 'جديد' },
        { path: '/price-history', icon: TrendingUp, label: 'سجل الأسعار', badge: 'جديد' }
      ]
    },
    {
      id: 'sales',
      ...
      items: [
        ...
        { path: '/invoices/sales', icon: Receipt, label: 'فواتير المبيعات', badge: null },
        { path: '/purchase-invoices', icon: ShoppingCart, label: 'فواتير المشتريات', badge: null },
        { path: '/purchase-orders', icon: ShoppingCart, label: 'أوامر الشراء', badge: 'جديد' },
        { path: '/sales-engineers', icon: Users, label: 'مهندسي المبيعات', badge: 'جديد' },
        { path: '/potential-customers', icon: Users, label: 'العملاء المحتملين (CRM)', badge: 'جديد' },
        { path: '/discounts', icon: Tags, label: 'إدارة الخصومات', badge: 'جديد' }
      ]
    },
    {
      id: 'hr',
      ...
      expandable: true,
      items: [
        { path: '/hr/employees', icon: UserCheck, label: 'إدارة الموظفين', badge: 'جديد' },
        { path: '/hr/departments', icon: Building2, label: 'الأقسام والهيكل التنظيمي', badge: 'جديد' },
        { path: '/hr/attendance', icon: Clock, label: 'الحضور والانصراف', badge: 'جديد' }
      ]
    },
    {
      id: 'accounting',
      ...
      items: [
        ...
        { path: '/accounting/vouchers', icon: Receipt, label: 'قسائم الدفع والقبض', badge: 'جديد' },
        { path: '/accounting/profit-loss', icon: TrendingUp, label: 'الأرباح والخسائر', badge: null },
        { path: '/treasury-management', icon: DollarSign, label: 'إدارة الخزينة', badge: 'جديد' },
        { path: '/profit-loss-reports', icon: BarChart3, label: 'تقارير الأرباح/الخسائر', badge: 'جديد' }
      ]
    },
    {
      id: 'reports',
    ...
    },
    {
      ...
      expandable: true,
      items: [
        { path: '/warehouse-adjustments', icon: Warehouse, label: 'تعديلات المخازن', badge: 'جديد' },
        { path: '/returns', icon: Receipt, label: 'إدارة المرتجعات', badge: 'جديد' },
        { path: '/debt-management', icon: CreditCard, label: 'إدارة المدفوعات والديون', badge: 'جديد' },
        { path: '/customer-credit', icon: CreditCard, label: 'إدارة ائتمان العملاء', badge: 'جديد' },
        { path: '/stock-movements', icon: Truck, label: 'أوامر الرفع والاستلام', badge: null },
    ...
    },
    {
      ...
      expandable: true,
      items: [
        { path: '/tools/import-export', icon: Upload, label: 'الاستيراد والتصدير', badge: null },
        { path: '/excel-operations', icon: FileText, label: 'عمليات Excel', badge: 'جديد' },
        { path: '/reports', icon: Printer, label: 'الطباعة والتصدير', badge: null }
      ]
    },
    {
      id: 'admin',
      ...
      items: [
        ...
        { path: '/security-dashboard', icon: Shield, label: 'لوحة الأمان', badge: 'جديد' },
        { path: '/audit-logs', icon: FileText, label: 'سجل التدقيق', badge: 'جديد' },
        { path: '/automation-tasks', icon: Settings, label: 'المهام الآلية', badge: 'جديد' },
        { path: '/mfa-settings', icon: Shield, label: 'المصادقة الثنائية', badge: 'جديد' },
        { path: '/backup-restore', icon: Database, label: 'النسخ الاحتياطي', badge: 'جديد' },
        { path: '/system-status', icon: Settings, label: 'حالة النظام', badge: 'جديد' }
      ]
    },
    {
      id: 'settings',
    ...
    },
    {
      ...
      expandable: true,
      items: [
        { path: '/dashboard', icon: BarChart3, label: 'لوحة المعلومات التفاعلية', badge: null },
        { path: '/system/setup-wizard', icon: Settings, label: 'معالج الإعداد', badge: 'جديد' },
        { path: '/user-management', icon: UserCog, label: 'إدارة المستخدمين المتقدمة', badge: null },
        { path: '/notifications-center', icon: AlertCircle, label: 'مركز الإشعارات', badge: 'جديد' }
      ]
    }
  ]
  ...
  const SectionHeader = ({ section, icon: SectionIcon, label, isExpanded, onToggle }) => (
    <button
      onClick={onToggle}
    ...
    >
      <div className="flex items-center">
        {SectionIcon && <SectionIcon className="w-5 h-5 ml-2 text-gray-500" />}
        <span>{label}</span>
      </div>
      {section.expandable && (
