...
export const productService = {
  ...
  async getExpired(params = {}) {
    try {
      const response = await apiClient.get('/products/expired', params);
      return response.products || response.data || [];
    } catch (error) {
  ...
  async getTopSelling(params = {}) {
    try {
      const response = await apiClient.get('/products/reports/top-selling', params);
      return response.products || response.data || [];
    } catch (error) {
  ...
  async getProfitability(params = {}) {
    try {
      const response = await apiClient.get('/products/reports/profitability', params);
      return response.products || response.data || [];
    } catch (error) {
  ...
  async checkBarcodeExists(barcode, excludeId = null) {
    try {
      ...
      const response = await apiClient.get('/products/check-barcode', params);
  ...
  async validateProduct(productData) {
    try {
      const response = await apiClient.post('/products/validate', productData);
      return response;
    } catch (error) {
