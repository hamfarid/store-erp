...
## 🔍 Documentation Search (Exa)
When integrating with external APIs, use Exa to find the latest documentation:
...
manus-mcp-cli tool call search --server firecrawl --input '{"query": "GitHub API v3 create repository endpoint"}'
```
