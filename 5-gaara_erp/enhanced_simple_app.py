...
from advanced_auth_system import auth_system, require_auth, require_admin, require_manager
...
def create_warehouse():
    ...
    try:
        ...
        return jsonify({
            'success': False,
            'error': 'اسم المستودع موجود بالفعل'
        }), 400
    except Exception as e:
        return jsonify({
            'success': False,
...
def create_product():
    ...
    try:
        ...
        return jsonify({
            'success': False,
            'error': 'رمز المنتج (SKU) موجود بالفعل'
        }), 400
    except Exception as e:
        return jsonify({
            'success': False,
