...
# Define mock classes first as fallbacks
class _MockModel:
    """Generic mock model for fallback."""
...
try:
    ...
    try:
        from src.models.inventory import Product  # fallback to legacy
    except Exception:
        Product = _MockModel  # type: ignore

try:
    from src.models.category import Category
except Exception:
    Category = _MockModel  # type: ignore

try:
    from src.models.customer import Customer
except Exception:
    Customer = _MockModel  # type: ignore

try:
    from src.models.supplier import Supplier
except Exception:
    Supplier = _MockModel  # type: ignore
