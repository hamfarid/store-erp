        ...
        try:
            ...
            return True'''
                ...
                if old_function in content:
                    ...
                    self.fixes_applied.append("إصلاح مشكلة SQLAlchemy context في database.py")
    ...
    def update_app_py_with_temp_api(self):
        ...
        ('routes.products', 'products_bp'),'''
                ...
                if blueprints_section in content:
                    content = content.replace(blueprints_section, new_blueprints_section)
    ...
    def fix_existing_api_endpoints(self):
        ...
        try:
            ...
            return jsonify({
                ...
                if 'try:' in content and 'from models.inventory import Product' in content:
                    # الكود موجود بالفعل
                    pass
                else:
                    # إضافة الكود
