    ...
    def _load_models(self) -> Dict[str, Optional[tf.keras.Model]]:
        ...
        for disease_type, model_config in self.models_config.items():
            ...
            try:
                ...
                models[disease_type] = {"model": model, "classes": classes}
...
if __name__ == "__main__":
    ...
    dummy_config = {
        ...
        "image_size": [224, 224],
        "models": {
            "viral": {"model_file": "viral_diseases_model.h5", "classes_file": "viral_diseases_classes.json"},
            "fungal": {"model_file": "fungal_diseases_model.h5", "classes_file": "fungal_diseases_classes.json"},
        },
        "database": {"diseases_db": "../../database/diseases.db"},  # مسار نسبي
    }
