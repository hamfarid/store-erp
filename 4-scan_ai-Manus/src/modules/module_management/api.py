...
from .module_controller import (
    get_module_status, start_module, stop_module, restart_module,
    get_module_cpu_usage, get_module_ram_usage, get_module_last_started,
    get_module_last_stopped, module_exists
)
...
def get_module_dependencies(module_name):
    ...
    module_dependencies = {
        ...
        "resource_monitoring": [],
        "alert_management": [],
        "integration_tests": ["performance_monitoring", "data_validation", "module_shutdown", "ai_management", "disease_diagnosis", "image_processing", "plant_hybridization"],
