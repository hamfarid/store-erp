            ...
            "agents": [
                {
                    ...
                    "type": "diagnosis",
                    "status": "active",
                    "capabilities": ["disease_detection", "treatment_recommendation"],
                ...
                },
                {
                    ...
                    "type": "monitoring",
                    "status": "active", 
                    "capabilities": ["system_monitoring", "error_detection"],
    ...
    try:
        ...
        for param in required_params:
            if param not in training_config:
                raise HTTPException(status_code=400, detail=f"المعامل {param} مطلوب")
