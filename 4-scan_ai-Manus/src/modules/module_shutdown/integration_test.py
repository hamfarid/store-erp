...
from modules.module_shutdown.ai_suspension_manager import AISuspensionManager, SuspensionReason, SuspensionState, SuspensionStrategy
    ...
    def start(self) -> bool:
        ...
        for callback in self.startup_callbacks:
            try:
                ...
                logger.error(f"فشل تنفيذ دالة الاستدعاء لبدء التشغيل: {str(e)}")
...
class ModuleManagerTest(unittest.TestCase):
    ...
    def test_start_stop_module(self):
        ...
        self.module_manager.register_startup_callback(module_id, mock_module.start)
        self.module_manager.register_shutdown_callback(module_id, mock_module.stop)

        # بدء تشغيل المديول
        self.assertTrue(self.module_manager.start_module(module_id))
        self.assertEqual(self.module_manager.modules[module_id].state, ModuleState.RUNNING)
        self.assertTrue(mock_module.is_running)

        # إيقاف تشغيل المديول
        self.assertTrue(self.module_manager.stop_module(module_id))
        self.assertEqual(self.module_manager.modules[module_id].state, ModuleState.STOPPED)
    ...
    def test_pause_resume_module(self):
        ...
        self.module_manager.register_startup_callback(module_id, mock_module.start)
        self.module_manager.register_shutdown_callback(module_id, mock_module.stop)
        self.module_manager.register_pause_callback(module_id, mock_module.pause)
        self.module_manager.register_resume_callback(module_id, mock_module.resume)
        ...
        self.assertEqual(self.module_manager.modules[module_id].state, ModuleState.PAUSED)
    ...
    def test_get_modules_by_state(self):
        ...
        self.module_manager.register_startup_callback("module1", self.mock_modules["module1"].start)
        self.module_manager.register_startup_callback("module2", self.mock_modules["module2"].start)
        ...
        stopped_modules = self.module_manager.get_modules_by_state(ModuleState.STOPPED)
    ...
    def test_get_modules_by_priority(self):
        ...
        high_priority_modules = self.module_manager.get_modules_by_priority(priority_min=4)
        low_priority_modules = self.module_manager.get_modules_by_priority(priority_max=2)
...
class PriorityDeterminerTest(unittest.TestCase):
    ...
    def test_determine_modules_to_shutdown_by_resource(self):
        ...
        self.mock_modules["module3"].update_resources({AIResourceType.CPU: 80.0})
        self.mock_modules["module4"].update_resources({AIResourceType.MEMORY: 90.0})
        ...
        modules_to_shutdown = self.priority_determiner.determine_modules_to_shutdown_by_resource(
            reason=ShutdownReason.RESOURCE_CRITICAL,
            resource_type=AIResourceType.CPU,
            threshold=70.0
        )
...
class SafeShutdownExecutorTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.shutdown_executor = SafeShutdownExecutor(self.module_manager, self.priority_determiner)
    ...
    def test_shutdown_modules_by_priority(self):
        ...
        # التحقق من حالة المديولات
        self.assertEqual(self.module_manager.modules["module1"].state, ModuleState.STOPPED)
        self.assertEqual(self.module_manager.modules["module2"].state, ModuleState.STOPPED)
        self.assertEqual(self.module_manager.modules["module3"].state, ModuleState.RUNNING)
        self.assertEqual(self.module_manager.modules["module4"].state, ModuleState.RUNNING)
        self.assertEqual(self.module_manager.modules["module5"].state, ModuleState.RUNNING)
...
class AIResourceMonitorTest(unittest.TestCase):
    ...
    def test_register_ai_module(self):
        ...
        self.assertEqual(self.resource_monitor.ai_resources["ai_module1"].name, "مديول الذكاء الصناعي الأول")
    ...
    def test_update_ai_module_resources(self):
        ...
        self.assertEqual(self.resource_monitor.ai_resources["ai_module2"].resources[AIResourceType.CPU], 50.0)
        self.assertEqual(self.resource_monitor.ai_resources["ai_module2"].resources[AIResourceType.MEMORY], 60.0)
        self.assertEqual(self.resource_monitor.ai_resources["ai_module2"].resources[AIResourceType.GPU], 70.0)
    ...
    def test_update_ai_module_limits(self):
        ...
        self.assertEqual(self.resource_monitor.ai_resources["ai_module3"].limits[AIResourceType.CPU], 90.0)
        self.assertEqual(self.resource_monitor.ai_resources["ai_module3"].limits[AIResourceType.MEMORY], 90.0)
        self.assertEqual(self.resource_monitor.ai_resources["ai_module3"].limits[AIResourceType.GPU], 90.0)
    ...
    def test_update_token_usage(self):
        ...
        self.assertEqual(self.resource_monitor.ai_resources["ai_module7"].resources[AIResourceType.TOKENS], 1000)
        ...
        # التحقق من تحديث استهلاك الرموز
        self.assertEqual(self.resource_monitor.ai_resources["ai_module7"].resources[AIResourceType.TOKENS], 1500)
    ...
    def test_update_api_calls(self):
        ...
        self.assertEqual(self.resource_monitor.ai_resources["ai_module8"].resources[AIResourceType.API_CALLS], 100)
        ...
        # التحقق من تحديث استدعاءات واجهة برمجة التطبيقات
        self.assertEqual(self.resource_monitor.ai_resources["ai_module8"].resources[AIResourceType.API_CALLS], 150)
    ...
    def test_reset_token_usage(self):
        ...
        self.assertEqual(self.resource_monitor.ai_resources["ai_module9"].resources[AIResourceType.TOKENS], 0)
    ...
    def test_reset_api_calls(self):
        ...
        self.assertEqual(self.resource_monitor.ai_resources["ai_module10"].resources[AIResourceType.API_CALLS], 0)
...
class AISuspensionManagerTest(unittest.TestCase):
    ...
    def test_register_ai_module(self):
        ...
        self.assertEqual(self.suspension_manager.ai_suspensions["ai_module1"].name, "مديول الذكاء الصناعي الأول")
    ...
    def test_suspend_resume_ai_module(self):
        ...
        self.assertEqual(self.suspension_manager.ai_suspensions["ai_module2"].state, SuspensionState.SUSPENDED)

        # استئناف مديول الذكاء الصناعي
        self.assertTrue(self.suspension_manager.resume_ai_module("ai_module2"))

        # التحقق من حالة مديول الذكاء الصناعي
        self.assertEqual(self.suspension_manager.ai_suspensions["ai_module2"].state, SuspensionState.ACTIVE)
    ...
    def test_get_ai_module_suspension(self):
        ...
        suspension_data = self.suspension_manager.get_ai_module_suspension("ai_module3")
        ...
        self.assertEqual(suspension_data["name"], "مديول الذكاء الصناعي الثالث")
        ...
        self.assertEqual(suspension_data["strategy"], SuspensionStrategy.GRACEFUL)
    ...
    def test_get_ai_modules_by_state(self):
        ...
        active_modules = self.suspension_manager.get_ai_modules_by_state(SuspensionState.ACTIVE)
        suspended_modules = self.suspension_manager.get_ai_modules_by_state(SuspensionState.SUSPENDED)
    ...
    def test_get_suspension_stats(self):
        ...
        self.assertEqual(stats["suspension_reasons"].get(SuspensionReason.MANUAL, 0), 1)
        self.assertEqual(stats["suspension_strategies"].get(SuspensionStrategy.GRACEFUL, 0), 1)
    ...
    def test_schedule_suspension(self):
        ...
        scheduled_suspensions = self.suspension_manager.get_scheduled_suspensions("ai_module11")

        # التحقق من مهام التعليق المجدولة
        self.assertEqual(len(scheduled_suspensions), 1)
        self.assertEqual(scheduled_suspensions[0]["ai_module_id"], "ai_module11")
        self.assertEqual(scheduled_suspensions[0]["reason"], SuspensionReason.SCHEDULED)
        self.assertEqual(scheduled_suspensions[0]["strategy"], SuspensionStrategy.GRACEFUL)
    ...
    def test_cancel_scheduled_suspension(self):
        ...
        self.assertTrue(self.suspension_manager.cancel_scheduled_suspension("ai_module12"))

        # الحصول على مهام التعليق المجدولة
        scheduled_suspensions = self.suspension_manager.get_scheduled_suspensions("ai_module12")
...
class IntegrationTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        for i in range(1, 6):
            ...
            self.resource_monitor.register_ai_module(ai_module_id, ai_module_name)
            self.suspension_manager.register_ai_module(ai_module_id, ai_module_name)
    ...
    def test_resource_critical_to_suspension(self):
        ...
        self.resource_monitor.register_alert_callback(ResourceAlert.CRITICAL, alert_callback)
        ...
        # التحقق من حالة مديول الذكاء الصناعي
        self.assertEqual(self.suspension_manager.ai_suspensions[ai_module_id].state, SuspensionState.SUSPENDED)
    ...
    def test_auto_resume_suspended_ai_module(self):
        ...
        # التحقق من حالة مديول الذكاء الصناعي
        self.assertEqual(self.suspension_manager.ai_suspensions[ai_module_id].state, SuspensionState.ACTIVE)
    ...
    def test_resource_monitoring_and_suspension(self):
        ...
        self.suspension_manager.register_suspension_callback(SuspensionState.SUSPENDED, suspension_callback)
