...
class SafeShutdownExecutor:
    ...
    def _load_config(self) -> bool:
        ...
        try:
            ...
            logger.info(f"تم تحميل تكوين منفذ الإغلاق الآمن من {self.config_path}")
            return True
    ...
    def _save_config(self) -> bool:
        ...
        try:
            ...
            logger.info(f"تم حفظ تكوين منفذ الإغلاق الآمن إلى {self.config_path}")
            return True
        except Exception as e:
    ...
    def _get_shutdown_strategy(self, module_id: str) -> str:
        ...
        strategy = settings.get("strategy", self.config.get("default_strategy", ShutdownStrategy.GRACEFUL))
    ...
    def _get_shutdown_timeout(self, module_id: str) -> int:
        ...
        timeout = settings.get("timeout", self.config.get("default_timeout", 30))
    ...
    def _get_max_shutdown_attempts(self, module_id: str) -> int:
        ...
        max_attempts = settings.get("max_attempts", self.config.get("max_shutdown_attempts", 3))
