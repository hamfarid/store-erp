    ...
    def generate_system_performance_report(self, report_config: ReportConfig) -> str:
        ...
        try:
            ...
            if report_config.output_format.lower() == "html":
                ...
                logger.warning(f"Unsupported output format: {report_config.output_format}")
                report_path = None
    ...
    def _create_system_performance_charts(self, df, report_config):
        ...
        try:
            ...
            if "cpu.total_percent" in df.columns:
                plt.figure(figsize=(report_config.chart_width, report_config.chart_height))
                plt.plot(df["timestamp"], df["cpu.total_percent"], marker='o', linestyle='-', color='#1f77b4')
            ...
            if "memory.percent" in df.columns:
                plt.figure(figsize=(report_config.chart_width, report_config.chart_height))
                plt.plot(df["timestamp"], df["memory.percent"], marker='o', linestyle='-', color='#ff7f0e')
            ...
            if "disk.percent" in df.columns:
                plt.figure(figsize=(report_config.chart_width, report_config.chart_height))
                plt.plot(df["timestamp"], df["disk.percent"], marker='o', linestyle='-', color='#2ca02c')
            ...
            if "network.bytes_sent" in df.columns and "network.bytes_recv" in df.columns:
                plt.figure(figsize=(report_config.chart_width, report_config.chart_height))
                plt.plot(df["timestamp"], df["network.bytes_sent"] / 1024 / 1024, marker='o', linestyle='-', color='#d62728', label="Sent")
                plt.plot(df["timestamp"], df["network.bytes_recv"] / 1024 / 1024, marker='o', linestyle='-', color='#9467bd', label="Received")
    ...
    def _create_module_performance_charts(self, df, module_id, report_config):
        ...
        try:
            ...
            if "performance.response_time_ms" in df.columns:
                plt.figure(figsize=(report_config.chart_width, report_config.chart_height))
                plt.plot(df["timestamp"], df["performance.response_time_ms"], marker='o', linestyle='-', color='#1f77b4')
            ...
            if "performance.error_rate" in df.columns:
                plt.figure(figsize=(report_config.chart_width, report_config.chart_height))
                plt.plot(df["timestamp"], df["performance.error_rate"] * 100, marker='o', linestyle='-', color='#d62728')
            ...
            if "resources.cpu_percent" in df.columns:
                plt.figure(figsize=(report_config.chart_width, report_config.chart_height))
                plt.plot(df["timestamp"], df["resources.cpu_percent"], marker='o', linestyle='-', color='#ff7f0e')
            ...
            if "resources.memory_percent" in df.columns:
                plt.figure(figsize=(report_config.chart_width, report_config.chart_height))
                plt.plot(df["timestamp"], df["resources.memory_percent"], marker='o', linestyle='-', color='#2ca02c')
    ...
    def _create_ai_performance_charts(self, df, ai_model_id, report_config):
        ...
        try:
            ...
            if "performance.inference_time_ms" in df.columns:
                plt.figure(figsize=(report_config.chart_width, report_config.chart_height))
                plt.plot(df["timestamp"], df["performance.inference_time_ms"], marker='o', linestyle='-', color='#1f77b4')
            ...
            if "performance.accuracy" in df.columns:
                plt.figure(figsize=(report_config.chart_width, report_config.chart_height))
                plt.plot(df["timestamp"], df["performance.accuracy"] * 100, marker='o', linestyle='-', color='#2ca02c')
            ...
            if "resources.gpu_percent" in df.columns:
                plt.figure(figsize=(report_config.chart_width, report_config.chart_height))
                plt.plot(df["timestamp"], df["resources.gpu_percent"], marker='o', linestyle='-', color='#ff7f0e')
            ...
            if "resources.memory_percent" in df.columns:
                plt.figure(figsize=(report_config.chart_width, report_config.chart_height))
                plt.plot(df["timestamp"], df["resources.memory_percent"], marker='o', linestyle='-', color='#d62728')
    ...
    def _create_database_performance_charts(self, df, db_name, report_config):
        ...
        try:
            ...
            if "performance.query_time_ms" in df.columns:
                plt.figure(figsize=(report_config.chart_width, report_config.chart_height))
                plt.plot(df["timestamp"], df["performance.query_time_ms"], marker='o', linestyle='-', color='#1f77b4')
            ...
            if "performance.active_connections" in df.columns:
                plt.figure(figsize=(report_config.chart_width, report_config.chart_height))
                plt.plot(df["timestamp"], df["performance.active_connections"], marker='o', linestyle='-', color='#ff7f0e')
            ...
            if "resources.connection_usage_percent" in df.columns:
                plt.figure(figsize=(report_config.chart_width, report_config.chart_height))
                plt.plot(df["timestamp"], df["resources.connection_usage_percent"], marker='o', linestyle='-', color='#2ca02c')
