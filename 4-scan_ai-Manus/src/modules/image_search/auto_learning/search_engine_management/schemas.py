...
class SearchEngineCreate(SearchEngineBase):
    ...
    def validate_base_url(cls, v):
        ...
        if not v.startswith(('http://', 'https://')):
            raise ValueError('يجب أن يبدأ عنوان URL الأساسي بـ http:// أو https://')
        return v
...
class SearchEngineLoadBalancerMappingCreate(SearchEngineLoadBalancerMappingBase):
...
class SearchEngineLoadBalancerMappingResponse(SearchEngineLoadBalancerMappingBase):
