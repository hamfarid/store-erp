...
class ModelValidator:
    ...
    def validate_data(self, data: Dict[str, Any], model_name: str) -> Tuple[bool, List[Dict[str, Any]]]:
        """
        ...
        if model_name not in self.models:
            ...
            return False, [{"field": "model", "error": f"النموذج '{model_name}' غير موجود"}]
        ...
        for field_name, field_value in data.items():
            if field_name in model["fields"]:
                ...
                if field_value is not None:
                    field_is_valid = self._validate_type(field_value, field_type, field_config)
    ...
    def _validate_type(self, value: Any, type_name: str, params: Dict[str, Any]) -> bool:
        """
    ...
    def add_model(self, model_name: str, model_definition: Dict[str, Any]) -> bool:
        """
        إضافة نموذج جديد.
    ...
    def update_model(self, model_name: str, model_definition: Dict[str, Any]) -> bool:
        """
        تحديث نموذج موجود.
    ...
    def validate_batch(self, data_list: List[Dict[str, Any]], model_name: str) -> List[Tuple[bool, List[Dict[str, Any]]]]:
        """
