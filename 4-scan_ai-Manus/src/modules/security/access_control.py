...
class AccessControl:
    ...
    def __init__(self, secret_key: str, activity_log_service: ActivityLogService,
                 user_service: UserService, telegram_notifier: TelegramNotifier):
        """
    ...
    async def require_permission(self, user: User, required_permission: str, request: Request) -> None:
        """
    ...
    async def handle_login_attempt(self, username: str, success: bool, request: Request) -> None:
        """
    ...
    async def block_ip(self, ip_address: str, duration_minutes: int = 30) -> None:
        """
        حظر عنوان IP
