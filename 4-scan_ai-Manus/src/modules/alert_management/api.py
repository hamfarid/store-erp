...
from . import (
    create_alert, get_alerts, get_alert, update_alert_status, delete_alert,
    get_alerts_config, update_alerts_config, alert_monitor
)
...
def api_start_alert_monitor():
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to start alert monitor: {str(e)}")
...
def api_stop_alert_monitor():
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to stop alert monitor: {str(e)}")
...
def api_get_alert_monitor_status():
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to get alert monitor status: {str(e)}")
