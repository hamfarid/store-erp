...
class BreedingPredictor:
    ...
    def _predict_quantitative_trait(
        self, parent1_value: float, parent2_value: float, heritability: float = 0.5
    ) -> float:
    ...
    def predict_hybridization(self, parent1_name: str, parent2_name: str) -> Dict[str, Any]:
        ...
        predictions = {
            ...
            "predicted_offspring": {"mendelian_traits": {}, "quantitative_traits": {}},
        ...
        heritability = parent1_info.get("heritability", {}).get(trait_name_quantitative, 0.5)
    ...
    def _run_monte_carlo_simulation(self, parent1_info: Dict, parent2_info: Dict) -> Dict:
        ...
        simulation_results = {"iterations": iterations, "quantitative_traits_distribution": {}}
    ...
    def suggest_breeding_pairs(self, target_trait: str, target_value: float, num_suggestions: int = 5) -> List[Dict]:
...
if __name__ == "__main__":
    ...
    dummy_config = {
        ...
        "database": {"strains_db": "../../database/plant_strains.db"},  # مسار نسبي
        "web_search": {"enable": False},  # تعطيل البحث على الويب في المثال
        "simulation": {"monte_carlo_iterations": 1000, "confidence_interval": 0.95},
    }
