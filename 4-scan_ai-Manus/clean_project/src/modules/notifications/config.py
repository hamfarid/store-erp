...
NOTIFICATIONS_CONFIG = {
    ...
    'NOTIFICATION_CHECK_INTERVAL': int(os.getenv('NOTIFICATION_CHECK_INTERVAL', 60)),  # بالثواني
    ...
    'NOTIFICATION_AGGREGATION_TIME_WINDOW': int(os.getenv('NOTIFICATION_AGGREGATION_TIME_WINDOW', 3600)),  # بالثواني
}
