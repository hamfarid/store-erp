...
class Notification(Base):
    ...
    type = Column(Enum(*NOTIFICATION_TYPES.values(), name='notification_type'), nullable=False)
    priority = Column(Enum(*NOTIFICATION_PRIORITIES.values(), name='notification_priority'), nullable=False)
    ...
    channels = relationship("NotificationChannel", back_populates="notification", cascade="all, delete-orphan")
...
class NotificationChannel(Base):
    ...
    channel = Column(Enum(*NOTIFICATION_CHANNELS.values(), name='notification_channel'), nullable=False)
...
class NotificationPreference(Base):
    ...
    notification_type = Column(Enum(*NOTIFICATION_TYPES.values(), name='notification_type'), nullable=False)
