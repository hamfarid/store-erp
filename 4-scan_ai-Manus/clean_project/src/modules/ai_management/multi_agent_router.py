# File: /home/ubuntu/ai_web_organized/src/modules/ai_management/multi_agent_router.py
"""
...
from memory_and_learning import (
    RoutingStrategy, EventType, ExternalAgentService, PerformanceService
)
...
class MultiAgentRouter:
    ...
    def __init__(self, external_agent_service: ExternalAgentService, performance_service: PerformanceService):
        """
    ...
    def route_request(self, request: Dict, user_id: Optional[str] = None, strategy: RoutingStrategy = RoutingStrategy.ROUND_ROBIN) -> Dict:
        """
    ...
    def _failover(self, agents, failed_agent, request, user_id, strategy):
        ...
        available_agents = [agent for agent in agents if agent.id != failed_agent.id]
        ...
        logger.info("التحويل التلقائي من الوكيل %s إلى الوكيل {backup_agent.id}", failed_agent.id)
