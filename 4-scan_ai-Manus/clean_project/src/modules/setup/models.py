...
class SetupLog(Base):
    ...
    status = Column(String(20), nullable=False)  # success, error, warning, info
...
class SetupIntegration(Base):
    ...
    integration_type = Column(String(50), nullable=False)  # setup, config, data
    integration_status = Column(String(20), nullable=False)  # pending, completed, failed
...
class SetupTask(Base):
    ...
    task_status = Column(String(20), nullable=False)  # pending, in_progress, completed, failed
