# File: /home/ubuntu/ai_web_organized/src/modules/disease_diagnosis/diagnosis_engine.py
"""
from flask import g
...
class DiagnosisEngine:
    ...
    def diagnose(self, symptoms, crop_type, image_features=None, environmental_conditions=None):
        """
        ...
        try:
            ...
            for disease in possible_diseases:
                score = self._calculate_match_score(disease, symptoms, image_features, environmental_conditions)
            ...
            probable_diseases = [ds for ds in disease_scores if ds["score"] >= threshold]
    ...
    def _calculate_match_score(self, disease, symptoms, image_features=None, environmental_conditions=None):
        """
        ...
        try:
            ...
            symptom_score = len(matching_symptoms) / max(len(symptoms), len(disease_symptoms))
            ...
            if image_features and "image_patterns" in disease:
                image_weight = 0.2
                image_score = self._calculate_image_match(disease["image_patterns"], image_features)
            ...
            if environmental_conditions and "environmental_factors" in disease:
                env_weight = 0.1
                env_score = self._calculate_environmental_match(disease["environmental_factors"], environmental_conditions)
    ...
    def _calculate_environmental_match(self, disease_factors, environmental_conditions):
        """
    ...
    def _analyze_environmental_impact(self, environmental_conditions, probable_diseases):
        """
        ...
        try:
            ...
            if "temperature" in environmental_conditions:
                ...
                if temp > 30:
                    impact_analysis["favorable_conditions"].append("درجة الحرارة المرتفعة تساعد على انتشار بعض الأمراض الفطرية")
                elif temp < 15:
                    impact_analysis["unfavorable_conditions"].append("درجة الحرارة المنخفضة تبطئ من تطور معظم الأمراض")
            ...
            if "humidity" in environmental_conditions:
                ...
                if humidity > 70:
                    impact_analysis["favorable_conditions"].append("الرطوبة العالية تساعد على انتشار الأمراض الفطرية والبكتيرية")
                elif humidity < 40:
                    impact_analysis["unfavorable_conditions"].append("الرطوبة المنخفضة تحد من انتشار معظم الأمراض الفطرية")
    ...
    def get_diagnosis_history(self, limit=10):
        ...
        sorted_history = sorted(self.diagnosis_history, key=lambda x: x["timestamp"], reverse=True)
    ...
    def get_diagnosis_statistics(self):
        ...
        try:
            ...
            # حساب معدل النجاح
            successful_diagnoses = sum(1 for d in self.diagnosis_history if d["result"] == "success")
            ...
            for crop in crop_distribution:
                crop_distribution[crop] = crop_distribution[crop] / total_diagnoses
