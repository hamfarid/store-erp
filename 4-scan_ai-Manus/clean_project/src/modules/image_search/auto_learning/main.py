...
# تسجيل أجهزة التوجيه
app.include_router(main_router, prefix="/api/auto_learning", tags=["auto_learning"])
app.include_router(
    keyword_router, prefix="/api/auto_learning/keywords", tags=["keywords"]
)
app.include_router(source_router, prefix="/api/auto_learning/sources", tags=["sources"])
app.include_router(
