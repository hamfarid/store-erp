...
from modules.image_search.auto_learning.search_engine_management.service import SearchEngineService
from modules.image_search.auto_learning.search_engine_management.models import SearchEngine, SearchEngineUsage
from modules.image_search.auto_learning.search_engine_management.schemas import SearchEngineCreate, SearchEngineUpdate
...
class TestSearchEngineService:
    ...
    def test_create_search_engine_already_exists(self, search_engine_service, db_session):
        """
    ...
    def test_update_search_engine(self, search_engine_service, db_session):
        ...
        # تنفيذ الاختبار
        result = search_engine_service.update_search_engine(engine_id, engine_update)
    ...
    def test_get_next_search_engine_round_robin(self, search_engine_service, db_session):
        """
    ...
    def test_record_search_engine_usage(self, search_engine_service, db_session):
        """
        ...
        assert abs(result.response_time - response_time) < 0.001  # Use approximate comparison for floats
