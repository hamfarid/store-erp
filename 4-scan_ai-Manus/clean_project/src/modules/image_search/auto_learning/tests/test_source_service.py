...
from modules.image_search.auto_learning.source_management.models import Source, SourceVerification
from modules.image_search.auto_learning.source_management.schemas import SourceCreate, SourceVerificationCreate
...
class TestSourceService:
    ...
    def test_update_source_trust_level(self, source_service, db_session):
        ...
        # تنفيذ الاختبار
        result = source_service.update_source_trust_level(source_id, new_trust_level)
