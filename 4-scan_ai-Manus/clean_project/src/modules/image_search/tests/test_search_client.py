...
class TestWebSearchClient(unittest.TestCase):
    ...
    def test_init(self):
        ...
        self.assertEqual(self.client.endpoint, "https://test-api.example.com/search")
    ...
    def test_search_images_by_disease(self, mock_get):
        ...
        mock_get.assert_called_once()
        args, kwargs = mock_get.call_args
        self.assertTrue("plant disease leaf rust symptoms" in kwargs["params"]["q"])
    ...
    def test_search_images_by_crop(self, mock_get):
        ...
        # تنفيذ البحث
        results = self.client.search_images_by_crop("wheat", condition="healthy", count=2)
        ...
        mock_get.assert_called_once()
        args, kwargs = mock_get.call_args
        self.assertTrue("wheat plant healthy condition" in kwargs["params"]["q"])
