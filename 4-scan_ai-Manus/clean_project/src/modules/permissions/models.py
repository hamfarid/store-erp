...
class Permission(Base, BaseModel):
    ...
    resource_type = Column(String(50), nullable=False)  # نوع المورد (مثل: user, product, invoice)
    action = Column(String(50), nullable=False)  # الإجراء (مثل: create, read, update, delete)
...
class Role(Base, BaseModel):
    ...
    name = Column(String(100), unique=True, nullable=False)
    description = Column(String(255), nullable=True)
    is_system_role = Column(Boolean, default=False)  # هل هو دور نظام (لا يمكن تعديله)
