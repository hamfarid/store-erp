    ...
    try:
        ...
        return {
            ...
            "io": {
                ...
                "read_time": disk_io.read_time if disk_io and hasattr(disk_io, 'read_time') else None,
                "write_time": disk_io.write_time if disk_io and hasattr(disk_io, 'write_time') else None
            },
...
def get_network_usage():
    ...
    try:
        ...
        percent = min(100, (total_bytes * 2) / max_bandwidth * 100)  # ضرب في 2 لأن الفترة الزمنية 0.5 ثانية

        return {
            "bytes_sent": bytes_sent,
            "bytes_recv": bytes_recv,
            "bytes_total": total_bytes,
            "packets_sent": net_io_counters_end.packets_sent - net_io_counters_start.packets_sent,
            "packets_recv": net_io_counters_end.packets_recv - net_io_counters_start.packets_recv,
            ...
            "dropin": net_io_counters_end.dropin - net_io_counters_start.dropin,
            "dropout": net_io_counters_end.dropout - net_io_counters_start.dropout,
            "percent": percent,
...
class ResourceCollector:
    ...
    def collect_database_resources(self):
        ...
        """
        try:
            # Read DB connection info from environment variables or use defaults
            ...
            logger.error(f"Error collecting PostgreSQL database resources: {str(e)}")
            return {}
