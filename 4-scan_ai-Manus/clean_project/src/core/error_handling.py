# File: /home/ubuntu/clean_project/src/core/error_handling.py
...
class ErrorHandler:
    ...
    def log_error(
        ...
        logger.error(f"خطأ في النظام: {error}", extra=context)
...
class ErrorReporter:
    ...
    def report_error(
        ...
        if severity == "critical":
            ...
            logger.critical(f"خطأ حرج: {error}", extra=context or {})
