...
def add_usage_record():
    ...
    try:
        ...
        if success:
            return {'success': True,
                    'message': 'تم إضافة سجل الاستخدام بنجاح'}, 201
        else:
    ...
    try:
        ...
        if not agent_id:
            return {'success': False,
                    'error': 'معرف وكيل الذكاء الصناعي مطلوب'}, 400
...
def visual_report(report_type):
    ...
    try:
        ...
        visual_reports_dir = os.path.join(
            report_generator.reports_dir, 'visual')
        ...
        chart_path = os.path.join(
            visual_reports_dir,
            f"{report_filename}_{chart_type}.png")
