# File:
# /home/ubuntu/ai_web_organized/src/modules/ai_usage_reports/tests/test_report_generator.py
"""
from flask import g
...
class TestAIUsageReportGenerator(unittest.TestCase):
    ...
    def test_load_usage_data(self):
        ...
        self.assertEqual(
            self.report_generator.usage_data[0]["user_id"],
            "user1")
        self.assertEqual(
            self.report_generator.usage_data[1]["user_id"],
            "user2")
    ...
    def test_add_usage_record(self):
        ...
        self.assertEqual(
            self.report_generator.usage_data[4]["user_id"],
            "user4")
        self.assertEqual(
            self.report_generator.usage_data[4]["agent_id"],
            "agent3")
        self.assertEqual(
            self.report_generator.usage_data[4]["module"],
            "organic_farming")
    ...
    def test_calculate_within_scope_percentage(self):
        ...
        # حساب النسبة
        percentage = self.report_generator._calculate_within_scope_percentage(
            self.report_generator.usage_data)
    ...
    def test_calculate_module_distribution(self):
        ...
        # حساب التوزيع
        distribution = self.report_generator._calculate_module_distribution(
            self.report_generator.usage_data)
    ...
    def test_calculate_user_activity(self):
        ...
        # حساب النشاط
        activity = self.report_generator._calculate_user_activity(
            self.report_generator.usage_data)
    ...
    def test_calculate_agent_activity(self):
        ...
        # حساب النشاط
        activity = self.report_generator._calculate_agent_activity(
            self.report_generator.usage_data)
    ...
    def test_extract_top_questions(self):
        ...
        top_questions = self.report_generator._extract_top_questions(
            self.report_generator.usage_data, limit=2)

        # التحقق من صحة النتائج
        self.assertEqual(len(top_questions), 2)
        self.assertEqual(
            top_questions[0]["question"],
            "ما هي أفضل طرق ري المحاصيل؟")
    ...
    def test_generate_daily_report(self):
        ...
        self.assertGreaterEqual(
            ...
            3)  # على الأقل 3 تفاعلات اليوم
        self.assertGreaterEqual(
            report["unique_users"],
            2)  # على الأقل 2 مستخدمين مختلفين
        self.assertGreaterEqual(
            report["unique_agents"],
            2)  # على الأقل 2 وكلاء مختلفين
    ...
    def test_generate_weekly_report(self):
        ...
        self.assertGreaterEqual(
            report["total_interactions"],
            4)  # على الأقل 4 تفاعلات في الأسبوع
        self.assertGreaterEqual(
            report["unique_users"],
            3)  # على الأقل 3 مستخدمين مختلفين
        self.assertGreaterEqual(
            report["unique_agents"],
            2)  # على الأقل 2 وكلاء مختلفين
    ...
    def test_generate_monthly_report(self):
        ...
        self.assertGreaterEqual(
            report["total_interactions"],
            4)  # على الأقل 4 تفاعلات في الشهر
        self.assertGreaterEqual(
            report["unique_users"],
            3)  # على الأقل 3 مستخدمين مختلفين
        self.assertGreaterEqual(
    ...
    def test_generate_user_report(self):
        ...
        self.assertEqual(
            report["total_interactions"],
            2)  # مستخدم1 لديه تفاعلين
        # مستخدم1 تفاعل مع وكيلين مختلفين
        self.assertEqual(report["unique_agents"], 2)
    ...
    def test_generate_agent_report(self):
        ...
        # وكيل1 تفاعل مع مستخدمين مختلفين
    ...
    def test_generate_module_report(self):
        ...
        # إنشاء تقرير المديول
        report = self.report_generator.generate_module_report(
            module="agriculture")
        ...
        self.assertEqual(
            report["total_interactions"],
            1)  # مديول الزراعة لديه تفاعل واحد
        # مديول الزراعة تفاعل معه مستخدم واحد
        self.assertEqual(report["unique_users"], 1)
        # مديول الزراعة تفاعل معه وكيل واحد
        self.assertEqual(report["unique_agents"], 1)
    ...
    def test_export_data(self):
        ...
        with open(json_path, 'r', encoding='utf-8') as f:
            ...
            # 4 سجلات أصلية + 1 سجل مضاف في اختبار سابق
