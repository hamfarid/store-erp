...
# File:
# /home/ubuntu/ai_web_organized/src/modules/ai_usage_reports/tests/test_api.py
"""
...
class TestAIUsageReportsAPI(unittest.TestCase):
    ...
    def test_add_usage_record(self):
        ...
        response = self.client.post(
            '/api/ai_usage_reports/add_usage_record',
            json={
                "user_id": "user3",
                "agent_id": "agent2",
    ...
    def test_daily_report(self):
        ...
        response = self.client.get(
            '/api/ai_usage_reports/daily_report?date=2025-05-17')
        ...
        # التحقق من استدعاء مولد التقارير بشكل صحيح
        self.report_generator.generate_daily_report.assert_called_once_with(
            date="2025-05-17")
    ...
    def test_weekly_report(self):
        ...
        response = self.client.get(
            '/api/ai_usage_reports/weekly_report?end_date=2025-05-17')
        ...
        # التحقق من استدعاء مولد التقارير بشكل صحيح
        self.report_generator.generate_weekly_report.assert_called_once_with(
            end_date="2025-05-17")
    ...
    def test_monthly_report(self):
        ...
        response = self.client.get(
            '/api/ai_usage_reports/monthly_report?month=5&year=2025')
        ...
        # التحقق من استدعاء مولد التقارير بشكل صحيح
        self.report_generator.generate_monthly_report.assert_called_once_with(
            month=5, year=2025)
    ...
    def test_user_report(self):
        ...
        response = self.client.get(
            '/api/ai_usage_reports/user_report?user_id=user1&start_date=2025-05-01&end_date=2025-05-17')
    ...
    def test_user_report_missing_user_id(self):
        ...
        response = self.client.get(
            '/api/ai_usage_reports/user_report?start_date=2025-05-01&end_date=2025-05-17')
    ...
    def test_agent_report(self):
        ...
        response = self.client.get(
            '/api/ai_usage_reports/agent_report?agent_id=agent1&start_date=2025-05-01&end_date=2025-05-17')
    ...
    def test_module_report(self):
        ...
        response = self.client.get(
            '/api/ai_usage_reports/module_report?module=agriculture&start_date=2025-05-01&end_date=2025-05-17')
    ...
    def test_export_data(self):
        ...
        # تعيين سلوك مولد التقارير المعدل
        mock_export_path = os.path.join(
            self.test_dir, 'ai_usage_data_20250517_123456.json')
        ...
        with patch('api.send_file', return_value=jsonify({"success": True})) as mock_send_file:
            response = self.client.get(
                '/api/ai_usage_reports/export_data?format=json&start_date=2025-05-01&end_date=2025-05-17&module=agriculture')
            ...
            mock_send_file.assert_called_once_with(
                mock_export_path, as_attachment=True)
    ...
    def test_visual_report(self):
        ...
        mock_chart_path = os.path.join(
            self.test_dir,
            'daily_visual_report_2025-05-17_module_distribution.png')
        ...
        with patch('os.path.exists', return_value=True), \
            ...
            response = self.client.get(
                '/api/ai_usage_reports/visual_report/daily?date=2025-05-17&chart_type=module_distribution')
