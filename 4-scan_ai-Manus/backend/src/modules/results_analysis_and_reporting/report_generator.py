...
# ReportTemplate, ReportSection, ReportDataItem, ChartType removed
from .models import VisualizationType

# import weasyprint # type: ignore[import-untyped] # Kept for reference,
# but commented as unused by Flake8
...
class ReportGenerator:
    def _render_data_item(
            self, item: Dict[str, Any], template_engine: jinja2.Environment) -> str:
        html_content = ""
    ...
    def _generate_chart_image(
            self, chart_data: Dict[str, Any], chart_type_str: str) -> Optional[str]:
    ...
    def generate_report_advanced(self, sections: List[Dict[str, Any]]) -> str:
        ...
        for section in sections:
            ...
            if item_type == "table_section":
                ...
                chart_image_base64 = self._generate_chart_image(
                    section_data, section.get("chart_type", "bar"))
