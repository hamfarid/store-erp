...
class MemoryAIIntegration:
    ...
    def _load_embedding_model(self):
        ...
        # في بيئة الإنتاج، يمكن استخدام نماذج مثل OpenAI أو Hugging Face أو
        # غيرها
    ...
    def chunk_text(self, text: str) -> List[str]:
        ...
        for paragraph in paragraphs:
            ...
            if len(current_chunk) + \
                    len(paragraph) <= self.max_tokens_per_chunk:
    ...
    def search_similar_memories(self,
                                ...
                                memory_embeddings: List[Tuple[str,
                                                              List[float]]],
        ...
        try:
            ...
            if category:
                high_importance_categories = [
                    "plant_data", "disease_data", "diagnosis_result"]
