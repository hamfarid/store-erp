...
class ImageStorage:
    ...
    def __init__(self, config: Dict[str, Any] = None):
        ...
        self.disease_images_path = os.path.join(
            self.base_storage_path, "diseases")
        ...
        self.uploaded_images_path = os.path.join(
            self.base_storage_path, "uploads")
    ...
    def store_image(self, source_path: str, category: str = "uploads") -> str:
        ...
        if not os.path.exists(source_path):
            raise FileNotFoundError(
                f"ملف الصورة المصدر غير موجود: {source_path}")
    ...
    def move_image(self, source_path: str, new_category: str,
