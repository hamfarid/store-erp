...
class FeedbackPermissions:
    ...
    # إدارة التغذية الراجعة (تغيير الحالة، الأولوية، إلخ)
...
FEEDBACK_SETTINGS = {
    ...
    "allowed_attachment_types": ["image/jpeg", "image/png", "image/gif", "application/pdf", "text/plain"],
    "max_feedback_title_length": 100,  # الحد الأقصى لطول عنوان التغذية الراجعة
    # الحد الأقصى لطول وصف التغذية الراجعة
    "max_feedback_description_length": 5000,
    "max_comment_length": 1000,  # الحد الأقصى لطول التعليق
    # أولوية التغذية الراجعة الافتراضية
    "default_feedback_priority": FeedbackPriority.MEDIUM,
    "default_feedback_status": FeedbackStatus.NEW,  # حالة التغذية الراجعة الافتراضية
    # إشعار المسؤولين عند إضافة تغذية راجعة جديدة
    "notify_admins_on_new_feedback": True,
    # إشعار المستخدم عند تغيير حالة التغذية الراجعة
    ...
    # عدد الأيام للاحتفاظ بالتغذية الراجعة المكتملة
    "days_to_keep_completed_feedback": 365,
    # عدد الأيام للاحتفاظ بالتغذية الراجعة المرفوضة
    "days_to_keep_rejected_feedback": 180,
}
