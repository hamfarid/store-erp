# File:
# /home/ubuntu/ai_web_organized/src/modules/integration_tests/test_frontend_backend_integration.py
"""
from flask import g
...
class TestFrontendBackendIntegration(unittest.TestCase):
        ...
        with patch('requests.get') as mock_get:
            ...
            for endpoint in endpoints:
                response = requests.get(
                    f"{self.api_url}{endpoint}", timeout=30)
    ...
    def test_disease_diagnosis_integration(self):
        ...
        with patch('requests.post') as mock_post:
            ...
            self.assertEqual(
                data["most_likely_disease"]["disease"],
                "اللفحة المتأخرة")
    ...
    def test_performance_monitoring_integration(self):
        ...
        with patch('requests.get') as mock_get:
            ...
            # محاكاة طلب من الواجهة الأمامية
            response = requests.get(
                f"{self.api_url}/api/performance-monitoring/metrics", timeout=30)
            ...
            self.assertEqual(data["metrics"]["system"]
                             ["memory"]["percent"], 50.0)
    ...
    def test_module_management_integration(self):
        ...
        with patch('requests.get') as mock_get:
            ...
            # محاكاة طلب من الواجهة الأمامية
            response = requests.get(
                f"{self.api_url}/api/module-management/list", timeout=30)
    ...
    def test_ai_management_integration(self):
        ...
        with patch('requests.get') as mock_get:
            ...
            # محاكاة طلب من الواجهة الأمامية
            response = requests.get(
                f"{self.api_url}/api/ai-management/agents", timeout=30)
