...
from modules.performance_monitoring.monitoring_interface import (
...
class PerformanceMonitoringIntegrationTest(unittest.TestCase):
    ...
    def _create_test_data(cls):
        ...
        for module in modules:
            module_metrics_file = os.path.join(
                cls.data_dir, f'module_{module}_metrics.json')
            module_metrics = []
        ...
        for model in ai_models:
            ai_metrics_file = os.path.join(
                cls.data_dir, f'ai_{model}_metrics.json')
            ai_metrics = []
            ...
            for i in range(24):
                ...
                metrics = {
                    ...
                    "performance.request_count": 1000 + i * 100,
                    # 0.7-0.95
                    "performance.cache_hit_ratio": 0.7 + (i % 6) * 0.05
                }
    ...
    def setUp(self):
        ...
        self.performance_analyzer = PerformanceAnalyzer(
            self.data_collector, self.config)
        self.report_generator = ReportGenerator(
            self.performance_analyzer, self.config)
    ...
    def test_performance_analyzer_initialization(self):
        ...
        self.assertEqual(
            self.performance_analyzer.data_collector,
            self.data_collector)
    ...
    def test_report_generator_initialization(self):
        ...
        self.assertEqual(
            self.report_generator.performance_analyzer,
            self.performance_analyzer)
    ...
    def test_performance_monitor_initialization(self):
        ...
        self.assertEqual(
            self.performance_monitor.data_collector,
            self.data_collector)
        self.assertEqual(
            self.performance_monitor.performance_analyzer,
            self.performance_analyzer)
        self.assertEqual(
            self.performance_monitor.report_generator,
            self.report_generator)
    ...
    def test_analyze_performance_trend(self):
        ...
        trend = self.performance_analyzer.analyze_performance_trend(
            "system", None, "1d")
    ...
    def test_generate_system_performance_report(self):
        ...
        # إنشاء التقرير
        report_path = self.report_generator.generate_system_performance_report(
            report_config)
    ...
    def test_generate_module_performance_report(self):
        ...
        report_path = self.report_generator.generate_module_performance_report(
            module_id, report_config)
        self.assertIsNotNone(report_path)
        self.assertTrue(os.path.exists(report_path))
    ...
    def test_generate_ai_performance_report(self):
        ...
        report_path = self.report_generator.generate_ai_performance_report(
            model_id, report_config)
        self.assertIsNotNone(report_path)
        self.assertTrue(os.path.exists(report_path))
    ...
    def test_monitoring_interface_initialization(self):
        ...
        interface = PerformanceMonitoringInterface(
            self.performance_monitor, self.config_path)
        self.assertIsNotNone(interface)
        self.assertEqual(
            interface.performance_monitor,
    ...
    def test_integration_end_to_end(self):
        ...
        # إنشاء واجهة مراقبة الأداء
        interface = PerformanceMonitoringInterface(
            performance_monitor, self.config_path)
        interface.create_templates()
        ...
        # محاكاة تحليل الأداء
        system_anomalies = performance_monitor.performance_analyzer.detect_performance_anomalies(
            "system", None, "1d")
        ...
        report_path = performance_monitor.report_generator.generate_system_performance_report(
            report_config)
        self.assertIsNotNone(report_path)
        self.assertTrue(os.path.exists(report_path))
