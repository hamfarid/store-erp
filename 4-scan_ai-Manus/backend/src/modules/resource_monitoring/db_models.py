# File:
# /home/ubuntu/ai_web_organized/src/modules/resource_monitoring/db_models.py
"""
from flask import g
...
class ResourceMetric(Base):
    ...
    def to_dict(self):
        ...
        return {
            ...
            "createdAt": self.created_at.isoformat() if hasattr(
                self,
                "created_at") and self.created_at else None,
            "updatedAt": self.updated_at.isoformat() if hasattr(
                self,
                "updated_at") and self.updated_at else None}
...
class ResourceDataPoint(Base):
    ...
    metric_id = Column(
        Integer,
        ForeignKey(RESOURCE_METRICS_ID),
        nullable=False)
    ...
    def to_dict(self):
        ...
        return {
            ...
            "timestamp": self.timestamp.isoformat() if hasattr(
                self,
                "timestamp") and self.timestamp else None,
...
class ResourceAggregation(Base):
    ...
    def to_dict(self):
        ...
        return {
            ...
            "startTime": self.start_time.isoformat() if hasattr(
                self,
                "start_time") and self.start_time else None,
            "endTime": self.end_time.isoformat() if hasattr(
                self,
                "end_time") and self.end_time else None,
