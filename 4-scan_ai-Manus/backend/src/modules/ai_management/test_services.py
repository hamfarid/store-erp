# File:
# /home/ubuntu/ai_web_organized/src/modules/ai_management/test_services.py
"""
...
class TestKnowledgeService(unittest.TestCase):
    ...
    def test_add_and_get_knowledge(self):
        ...
        # استرجاع المعرفة
        retrieved_knowledge = self.knowledge_service.get_knowledge(
            knowledge.id)
...
class TestPerformanceService(unittest.TestCase):
    ...
    def test_log_event(self):
        ...
        log_entry = self.performance_service.log_event(
            ...
            output_data={
                "response": "الذكاء الاصطناعي هو فرع من علوم الحاسوب يهتم بإنشاء آلات ذكية."},
            response_time=0.5,
            status="success")
    ...
    def test_get_agent_performance(self):
        ...
        performance = self.performance_service.get_agent_performance(
            "test_agent")
...
class TestExternalAgentService(unittest.TestCase):
    ...
    def test_register_and_get_agent(self):
        ...
        self.assertEqual(
            agent.capabilities, {
                "text_generation": True, "image_generation": False})
        self.assertEqual(
            agent.rate_limits, {
                "daily_limit": 1000, "minute_limit": 60})
    ...
    def test_update_usage_stats(self):
        ...
        result = self.external_agent_service.update_usage_stats(
            agent.id, tokens=10)
...
class TestRouterService(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.router_service = RouterService(
            self.db_session, self.external_agent_service)
    ...
    def test_create_and_get_router(self):
        ...
        self.assertEqual(
            router.routing_rules, {
                "default_agent": "test_agent_1"})
        self.assertEqual(
            router.failover_settings, {
    ...
    def test_update_router(self):
        ...
        self.assertEqual(
            updated_router.routing_strategy,
...
class TestPermissionService(unittest.TestCase):
    ...
    def test_get_agent_permissions(self):
        ...
        permissions = self.permission_service.get_agent_permissions(
            "test_agent")
