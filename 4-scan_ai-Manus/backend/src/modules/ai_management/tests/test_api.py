from modules.ai_management.api import init_default_data, load_data, save_data

# File:
# /home/ubuntu/ai_web_organized/src/modules/ai_management/tests/test_api.py
"""
from flask import g
...
class TestAIManagementAPI(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.original_data_dir = os.path.join(
            os.path.dirname(os.path.abspath(__file__)), '../data')
        self.patcher = patch(
            'modules.ai_management.api.DATA_DIR',
            self.test_dir)
