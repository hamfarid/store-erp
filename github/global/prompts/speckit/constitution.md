# /speckit.constitution (Global System v26 Diamond 32 Synchronized Intelligence Edition)

**Goal:** Create or update the project's governing principles, development guidelines, and architectural vision using the **Agentic Engine**.
...
5.  **Define Roles:** List the key roles (Builder, Critic, Sentinel) and their responsibilities in this specific project.
...
*   This project operates under the **Singularity System Global System v26 Diamond 32**.
*   All code must pass the **Sentinel Protocol**.
