# PROMPT 71: MEMORY & GAMIFICATION (Global System v26 Diamond 32)

## 1. The "Project Memory" Structure
**Rule:** Every project MUST have a `memory-bank/` folder containing:
...
## 2. The Gamification System (New in Global System v26 Diamond 32)
...
# Persistent Memory System (Global System v26 Diamond 32)
...
## 3. Technical Context
- **Stack:** React 19.2.4, Supabase, Tailwind v4.
