...
*   Using outdated version numbers (e.g., `v15.0` instead of `v26.0 Diamond 32 GAARA AI`).
...
python3 tools/verify_context.py --target README.md --expect "Global System v26 Diamond 32"
```
