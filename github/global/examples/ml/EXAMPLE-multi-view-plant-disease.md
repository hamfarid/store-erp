...
# Compliance: Global System v26 Diamond 32 v26 Diamond 2
...
# PyTorch==2.10.0  torchvision==0.25.0  timm==1.0.24
# opencv-python==4.13.0.92  albumentations==2.0.14  chromadb==1.5.0
...
`errors/ml/ERROR-multi-view-pipeline-catalog.md` for error code definitions, and
