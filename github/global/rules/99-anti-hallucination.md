# 🛑 RULE 99: ANTI-HALLUCINATION & GROUNDING PROTOCOL (Global System v26 Diamond 32)
...
## 3. ADVANCED ANTI-HALLUCINATION TECHNOLOGIES (v26.0+)
...
✅ **Good:**
1.  Read `the tools directory` or list directory `tools/`.
...
- Always run `grep` or `ls` to confirm before referencing any file.
