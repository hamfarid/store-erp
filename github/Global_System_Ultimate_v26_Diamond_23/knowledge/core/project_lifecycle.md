...
This document defines the **Standard Operating Procedure (SOP)** for the entire lifecycle of any project built under the Global System Ultimate.
...
*   **Step 2.1: Task Breakdown:**
    ...
    *   Assign roles (Architect, Developer, Reviewer) per `global_system/workflows/swarm_protocol.md`.
...
*   **Step 3.2: Security First:**
    *   Check against `knowledge/owasp_llm_2025.md`.
