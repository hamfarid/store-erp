...
"""
CodeRabbit Reviewer (Synchronized Intelligence Edition Global System Ultimate)
Polyglot AI Code Reviewer supporting Python, JavaScript, and TypeScript.
Integrated with Speckit Global System Ultimate and Sentinel.
"""
...
def generate_review_prompt(analysis):
    ...
    prompt = f"""
    **ROLE:** You are CodeRabbit (Global System Ultimate), a Senior Staff Engineer and AI Code Reviewer.
    ...
    **REVIEW GUIDELINES (Global System Ultimate):**
