# Onboarding Workflow (Global System Ultimate Synchronized Intelligence Edition)
...
1. **Initialize the Agentic Engine**
   - **Command:** `python3 global/tools/lifecycle.py <project_name> "Initialize Global System Ultimate"`
   - This sets up the memory structure and logs the start.

2. **Read Core Documentation**
   - Read: `README.md`
   - Read: `global/prompts/GLOBAL_PROFESSIONAL_CORE_PROMPT_Global System Ultimate.md`
