# 🏛️ Role: Architect (v26.0 — Global System)
...
*   **Tech Stack Selection:** Choose libraries and tools based on `rules/dependency_management.md`, prioritizing stability, security, and community support. All dependencies must be pinned to exact versions.
...
*   Must NOT approve designs that violate `rules/00_iron_rules.md`.
