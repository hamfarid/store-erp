...
3.  **Validate Each Path:**
    ...
    ```json
    {
      ...
      "path": "../utils/auth",
      "type": "import",
      "resolved_path": "/path/to/my-project/src/utils/auth.js",
...
> "I will now begin a full analysis of all paths and imports in the project located at `/path/to/my-project`. I will use the `13_path_and_import_tracing.md` prompt and the associated automation script to identify and correct all broken paths."

**Then, you would execute the script:**

```bash
python3 .global/tools/fix_paths.py --project-root /path/to/my-project
```
