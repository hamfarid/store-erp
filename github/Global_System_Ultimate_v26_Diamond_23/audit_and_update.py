...
def update_file(filepath):
    try:
        ...
        # 1. Replace hardcoded versions in headers/comments (e.g., v15.X -> v15.9.8)
        ...
        # Update "Global System Ultimate vXX.X"
        content = re.sub(r"Global System Ultimate v\d+\.\d+(\.\d+)?", f"Global System Ultimate {VERSION}", content)
        
        # Update "v15.9" or similar standalone if it looks like a version tag in a header
