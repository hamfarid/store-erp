# Project Brief — Global System Ultimate (v26.0 Diamond 9)
...
To establish a Global Standard for AI-driven software development, ensuring that every project starts with a secure, scalable, and intelligent foundation. The Global System Ultimate provides a complete governance framework that guides AI agents through the entire software development lifecycle — from architecture through deployment and monitoring.
...
-   **100% Compliance**: All files in the framework adhere to the Global System Ultimate v26 standard. No skeletal files, no broken cross-references, no version inconsistencies.
...
The primary governance document is `AGENTS.md`. Bootstrap guide: `BOOTSTRAP_v15.9.md`. Claude Code compatibility: `CLAUDE.md`. Iron rules: `rules/00_iron_rules.md`. ML governance: `rules/ml/` directory.
