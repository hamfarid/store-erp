...
-   **Iron Rules**: `rules/00_iron_rules.md` — MCP usage is subject to all iron rules.
-   **Error Catalog**: `errors/DONT_MAKE_THESE_ERRORS_AGAIN.md` — Error #C003 (hallucinated imports/APIs).
-   **Context Engineering**: `rules/context-engineering.md` — MCP supports the Context First protocol.
