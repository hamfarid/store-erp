# Context Engineering Rules (v26.0 — Global System Ultimate)
...
**Manual Override**: If `speckit analyze` is unavailable, manually load these files in order: `AGENTS.md` → `memory-bank/activeContext.md` → `rules/00_iron_rules.md` → task-specific rules.
